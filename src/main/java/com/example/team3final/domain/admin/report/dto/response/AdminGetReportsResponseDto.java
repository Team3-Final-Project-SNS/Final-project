...
public record AdminGetReportsResponseDto(
    ...
    public static AdminGetReportsResponseDto of(Report report, String reporterNickname) {
        return new AdminGetReportsResponseDto(
                report.getId(),
                reporterNickname,
                report.getTargetId(),
                report.getReason(),
